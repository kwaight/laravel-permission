...
return [
    ...
    'table_columns' => [
         ...
         */
        'tenants' => [
            'name' => 'tenant_name', //Name of the Column used for looking up by tenant Name
        ]
    ],
     ...
     */
    'foreign_keys' => [
        'tenants' => 'id', //Primary key for tenant table
        'roles' => 'id', //Primary key for role table
        'users' => 'id', //Primary key for user table
    ],
